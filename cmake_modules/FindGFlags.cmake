...
message(STATUS "GFLAGS_LIBS : ${GFLAGS_LIBS}")

        
find_library(GFLAGS_STATIC_LIB gflags PATHS ${GFLAGS_SEARCH_LIB_PATH} PATH_SUFFIXES lib lib64)
message(STATUS "GFLAGS_STATIC_LIB : ${GFLAGS_STATIC_LIB}")

find_library(GFLAGS_SHARED_LIB gflags PATHS ${GFLAGS_SEARCH_LIB_PATH} PATH_SUFFIXES lib lib64)
